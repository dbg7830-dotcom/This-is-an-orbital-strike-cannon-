...
public class StabRodItem extends FishingRodItem {
    ...
    private void consumeRod(ItemStack stack, ServerPlayerEntity player, Hand hand) {
        ...
        // Finite rod, get out bro you shouldn't be seeing ts
    ...
    public static ItemStack createStack(StabRodItem item, int uses) {
        ...
        // Force fishing rod model on 1.21.1
        stack.set(DataComponentTypes.CUSTOM_MODEL_DATA, 0);
        ...
        List<Text> lore = uses == -1
                ...
                : List.of(Text.literal("§6§l1 use per rod — use it wisely."),
                          Text.literal("§c§lAim at a block and right-click to fire."));
